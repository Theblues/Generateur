...
public class MenuBar implements ActionListener
{
	...
	public MenuBar()
	{
		...
		itemParagraphe.setIcon(new ImageIcon("images/add-paragraph.png"));
		itemParagraphe.addActionListener(this);

		itemImage = new JMenuItem("Ajouter une image");
		itemImage.setIcon(new ImageIcon("images/add-image.png"));
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			int option = Controleur.creerOptionPaneConfirm("Sauvegarder",
		...
		if (mi.equals(itemGenererPage))
		{
			...
			else
			{
				...
				Controleur.metier.getGenerator().generateFile(projet, page);
				Controleur.creerOptionPane("info", "Generation de la page "
						+ page.getNom() + " accompli");
			}
		}
